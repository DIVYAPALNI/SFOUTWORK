...
const CGFloat kDIDatepickerHeight = 90;
const CGFloat kDIDatepickerSpaceBetweenItems = 20.;
...
- (void)setupViews
{
    ...
    self.backgroundColor = [UIColor colorWithRed:231.0/255.0 green:231.0/255.0 blue:229.0/255.0 alpha:1];
    self.bottomLineColor = [UIColor colorWithWhite:0.816 alpha:1.000];
   // self.selectedDateBottomLineColor = self.tintColor;
    self.selectedDateBottomLineColor = [UIColor colorWithRed:65.0/255.0 green:150.0/255.0 blue:243.0/255.0 alpha:1];
}
...
- (void)fillCurrentDay
{
    [self fillDatesWithCalendarUnit:NSCalendarUnitDay];
}
